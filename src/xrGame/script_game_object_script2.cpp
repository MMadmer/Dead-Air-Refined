...
luabind::class_<CScriptGameObject>& script_register_game_object1(luabind::class_<CScriptGameObject>& instance)
{
    ...
    instance
        ...
        .def("get_weapon_fouling", &CScriptGameObject::GetWeaponFouling)
        .def("get_weapon_stress", &CScriptGameObject::GetWeaponStress)
        .def("get_weapon_fouling_ratio", &CScriptGameObject::GetWeaponFoulingRatio)
        .def("get_weapon_wear_progress", &CScriptGameObject::GetWeaponWearProgress)
        .def("is_weapon_ammo_in_magazine", &CScriptGameObject::IsWeaponAmmoInMagazine)
        .def("set_filters_elapsed", &CScriptGameObject::SetHelmetFiltersElapsed)
        .def("get_filters_elapsed", &CScriptGameObject::GetHelmetFiltersElapsed)
