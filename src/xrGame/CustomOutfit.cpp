...
// A hardcoded cap here silently shaved belt slots off outfits and ate the "+1 belt slot"
// upgrade whenever the mod's inventory/max_belt exceeded it.
static u32 belt_capacity()
{
    return pSettings->read_if_exists<u32>("inventory", "max_belt", 5);
}
...
void CCustomOutfit::Load(LPCSTR section)
{
    ...
    // The belt ceiling belongs to the mod config, same source CInventory reads.
    clamp(m_artefact_count, (u32)0, belt_capacity());
