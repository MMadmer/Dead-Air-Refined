    ...
    [
        ...
        class_<KeyBindingRegistrator>("DIK_keys")
            ...
            [
                ...
                value("DIK_PGUP",                   int(SDL_SCANCODE_PAGEUP)),
                value("DIK_DELETE",                 int(SDL_SCANCODE_DELETE)),
                value("DIK_END",                    int(SDL_SCANCODE_END)),
                value("DIK_PGDN",                   int(SDL_SCANCODE_PAGEDOWN)),
                ...
                // Preserve DirectInput aliases exposed by the original engine.
                value("DIK_SYSRQ",                  int(SDL_SCANCODE_PRINTSCREEN)),
                ...
                value("DIK_KANA",                   int(SDL_SCANCODE_LANG3)),
                value("DIK_CONVERT",                int(SDL_SCANCODE_INTERNATIONAL4)),
                value("DIK_NOCONVERT",              int(SDL_SCANCODE_INTERNATIONAL5)),
                value("DIK_KANJI",                  int(SDL_SCANCODE_LANG2)),
                value("DIK_UNDERLINE",              int(SDL_SCANCODE_INTERNATIONAL1)),
                value("DIK_CIRCUMFLEX",             int(SDL_SCANCODE_EQUALS)),
                value("DIK_COLON",                  int(SDL_SCANCODE_APOSTROPHE)),
                value("DIK_UNLABELED",              int(SDL_SCANCODE_INTERNATIONAL9)),
                value("DIK_AT",                     int(SDL_SCANCODE_LEFTBRACKET)),
                value("DIK_AX",                     int(SDL_SCANCODE_INTERNATIONAL8)),
