...
| Wind motors do not tear tree crowns | Rookie village, stalkers walking under the poplars, a shot fired through a crown, a grenade beside a tree | Pass: no crown card shoots out into a spike while someone walks past the trunk or a bullet passes through the leaves - a press motor fades out between 2.2 m and 3.2 m above the root, a shot's wake between three and six metres; the grenade blast still bends the whole tree and it springs back |
| Wind motors still move what a walker reaches | Cordon, walk into a bush and through the low branches of a spruce, fire a shot through a bush | Pass: the bush and the low branches (under 2.2 m) swing from a step and shake from a shot as strongly as before the crown fix; only the crown above three metres stays still |
