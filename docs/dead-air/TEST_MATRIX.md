...
| Main-menu runtime | Windowed R4 startup with no active level | Pass, `ui_main_menu.script` loaded and the process remained responsive without fatal or access-violation errors |
