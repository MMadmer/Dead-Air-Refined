-- The visor in a STORM, filmed as the field: the wind laid over every track, and the cones and
-- the bare glass the player saw were what the transport did to diagonal runs.
--
