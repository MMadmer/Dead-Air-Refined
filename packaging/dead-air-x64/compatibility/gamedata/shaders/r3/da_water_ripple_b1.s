...
function normal (shader, t_base, t_second, t_detail)
	...
	-- Band 1 of the ripple field (0.6 m rings): da_water_ripple.s with this band's previous
	-- half. The pass writes into $user$water_ripple1 and copies the result back into this
	-- half, so this name is always "one step ago" and never the target being written.
	shader:dx10texture	("s_water_ripple_prev",	"$user$water_ripple1p")
