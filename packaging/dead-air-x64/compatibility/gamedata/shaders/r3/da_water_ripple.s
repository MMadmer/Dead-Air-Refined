...
function normal (shader, t_base, t_second, t_detail)
	...
	-- The previous step. The pass writes into $user$water_ripple0 and copies the result back
	-- into this half, so this name is always "one step ago" and never the target being written.
	shader:dx10texture	("s_water_ripple_prev",	"$user$water_ripple1")
