...
`Dead-Air-Refined-1.3.5-Setup.exe`; it supports both first-time installation
and manual upgrades from an earlier Refined version. Use
`Dead-Air-Refined-1.3.5-Update.zip` when you prefer a fully manual installation:
...
3. Download `Dead-Air-Refined-1.3.5-Setup.exe` from the latest release.
...
```powershell
tools\package\build_dead_air_x64_installer.ps1 -PortVersion 1.3.5
```
